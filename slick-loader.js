...
class Slickloader{
	...
	constructor(parent){
		 ...
		 * @private
		 */
		this._parent = parent ? parent instanceof Element ? parent : document.querySelector(parent) : document.getElementsByTagName('body')[0];
	 ...
	 */
	clearText(){
		let textList = this.element.getElementsByTagName('text');
		textList[0].innerHTML = '';
		textList[1].innerHTML = '';
